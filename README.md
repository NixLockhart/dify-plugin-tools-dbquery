...
Currently supported database types: mysql, oracle, [oracle11g](./db_query/README.md#2-how-to-connect-to-oracle-11g--如何连接oracle-11g), postgresql, mssql, or [dm (DaMeng)](./db_query/README.md#3-how-to-connect-to-dm-dameng-database--如何连接达梦数据库).

目前支持的数据库类型：mysql、oracle、[oracle11g](./db_query/README.md#2-how-to-connect-to-oracle-11g--如何连接oracle-11g)、postgresql、mssql、[dm（达梦）](./db_query/README.md#3-how-to-connect-to-dm-dameng-database--如何连接达梦数据库)。
